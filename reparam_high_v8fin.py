...
x2 = solver_anom.pcs(pcscaling = 1)[:, 2] # questi sono uguali ai dotprods sotto
x3 = solver_anom.pcs(pcscaling = 1)[:, 3] # questi sono uguali ai dotprods sotto
x4 = solver_anom.pcs(pcscaling = 1)[:, 4] # questi sono uguali ai dotprods sotto
